...
and evaluates a separate seven-model Objaverse CC BY visual pack without silently
...
## Verified reproduction snapshot (2026-08-24)

The stable-demo completion gate has been met on the checked-in implementation:

| Evidence | Result | Interpretation |
| --- | ---: | --- |
| Unit/integration tests | 20 passed | Parser, geometry, agent routing, core and complex dense families, pipeline, evaluation, and licensed-asset quality/integrity |
...
| Licensed asset pack v2 | 7/7 files validated | CC BY 4.0, SHA-256, Objaverse++ score 3, opaque-only, thumbnail plus Genesis QA |
...
The optional `objaverse_cc_by_v2` manifest overlays licensed GLB visuals on the
...
this intentionally isolates visible-asset changes from physical acceptance. The
v2 dense sink uses two variants each of textured plates, bowls, and cups; its
